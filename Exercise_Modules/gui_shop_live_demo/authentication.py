...
from Exercise_Modules.gui_shop_live_demo.canvas import tk
from Exercise_Modules.gui_shop_live_demo.helpers import clean_screen
from Exercise_Modules.gui_shop_live_demo.products import render_products
